...
export const BRANDS: Brand[] = [
  ...
  { id: 'dior', name: 'Dior', category: 'Luxury / Fashion', difficulty: 'easy', color: '#111111', bg: '#F2EFE6', fontFamily: 'serif', letterSpacing: 'wider', shape: 'plain', uppercase: true },
  ...
  { id: 'new-balance', name: 'New Balance', category: 'Streetwear', difficulty: 'easy', color: '#8A1538', bg: '#F2EFE6', fontFamily: 'sans', letterSpacing: 'tight', shape: 'plain', uppercase: true },
  ...
  { id: 'figma', name: 'Figma', category: 'Design & Creative Tools', difficulty: 'easy', color: '#111111', bg: '#F2EFE6', fontFamily: 'sans', letterSpacing: 'normal', shape: 'plain', uppercase: false },
  ...
  { id: 'behance', name: 'Behance', category: 'Design & Creative Tools', difficulty: 'medium', color: '#0057FF', bg: '#111111', fontFamily: 'sans', letterSpacing: 'tight', shape: 'plain', uppercase: false },
  { id: 'dribbble', name: 'Dribbble', category: 'Design & Creative Tools', difficulty: 'medium', color: '#EA4C89', bg: '#111111', fontFamily: 'sans', letterSpacing: 'normal', shape: 'roundel', uppercase: false },
  { id: 'autodesk', name: 'Autodesk', category: 'Design & Creative Tools', difficulty: 'hard', color: '#111111', bg: '#F2EFE6', fontFamily: 'sans', letterSpacing: 'wide', shape: 'plain', uppercase: false },
  { id: 'blender', name: 'Blender', category: 'Design & Creative Tools', difficulty: 'medium', color: '#EA7600', bg: '#111111', fontFamily: 'sans', letterSpacing: 'normal', shape: 'roundel', uppercase: false },
  ...
  // Automotive
  { id: 'porsche', name: 'Porsche', category: 'Automotive', difficulty: 'medium', color: '#B8860B', bg: '#111111', fontFamily: 'serif', letterSpacing: 'wider', shape: 'shield', uppercase: true },
  { id: 'ferrari', name: 'Ferrari', category: 'Automotive', difficulty: 'easy', color: '#FFC72C', bg: '#8A1538', fontFamily: 'serif', letterSpacing: 'wide', shape: 'shield', uppercase: true },
  { id: 'lamborghini', name: 'Lamborghini', category: 'Automotive', difficulty: 'medium', color: '#B8860B', bg: '#111111', fontFamily: 'serif', letterSpacing: 'wide', shape: 'shield', uppercase: true },
  { id: 'bmw', name: 'BMW', category: 'Automotive', difficulty: 'easy', color: '#0B3B8C', bg: '#F2EFE6', fontFamily: 'sans', letterSpacing: 'wider', shape: 'roundel', uppercase: true },
  ...
  { id: 'audi', name: 'Audi', category: 'Automotive', difficulty: 'medium', color: '#B8860B', bg: '#111111', fontFamily: 'sans', letterSpacing: 'wider', shape: 'plain', uppercase: true },
  { id: 'rolls-royce', name: 'Rolls-Royce', category: 'Automotive', difficulty: 'hard', color: '#111111', bg: '#C7CACB', fontFamily: 'serif', letterSpacing: 'wider', shape: 'plain', uppercase: true },
  { id: 'bentley', name: 'Bentley', category: 'Automotive', difficulty: 'hard', color: '#0B3B24', bg: '#F2EFE6', fontFamily: 'serif', letterSpacing: 'wide', shape: 'shield', uppercase: true },
  { id: 'aston-martin', name: 'Aston Martin', category: 'Automotive', difficulty: 'hard', color: '#0B6B4F', bg: '#F2EFE6', fontFamily: 'serif', letterSpacing: 'wide', shape: 'shield', uppercase: true },
  { id: 'maserati', name: 'Maserati', category: 'Automotive', difficulty: 'hard', color: '#111111', bg: '#0B3B8C', fontFamily: 'serif', letterSpacing: 'wide', shape: 'shield', uppercase: true },

  // Food & Lifestyle
  { id: 'starbucks', name: 'Starbucks', category: 'Food & Lifestyle', difficulty: 'easy', color: '#FFFFFF', bg: '#00704A', fontFamily: 'sans', letterSpacing: 'wide', shape: 'roundel', uppercase: false },
  ...
  // Tech & Culture
  { id: 'sony', name: 'Sony', category: 'Tech & Culture', difficulty: 'easy', color: '#111111', bg: '#F2EFE6', fontFamily: 'sans', letterSpacing: 'wide', shape: 'plain', uppercase: true },
  ...
  { id: 'playstation', name: 'PlayStation', category: 'Tech & Culture', difficulty: 'medium', color: '#F2EFE6', bg: '#0B3B8C', fontFamily: 'sans', letterSpacing: 'tight', shape: 'plain', uppercase: false },
  { id: 'spotify', name: 'Spotify', category: 'Tech & Culture', difficulty: 'easy', color: '#111111', bg: '#1DB954', fontFamily: 'sans', letterSpacing: 'tight', shape: 'roundel', uppercase: false },
  ...
  { id: 'kodak', name: 'Kodak', category: 'Tech & Culture', difficulty: 'medium', color: '#F2EFE6', bg: '#B8171F', fontFamily: 'sans', letterSpacing: 'tight', shape: 'box', uppercase: true },
  ...
  { id: 'jbl', name: 'JBL', category: 'Tech & Culture', difficulty: 'hard', color: '#F2EFE6', bg: '#F58220', fontFamily: 'sans', letterSpacing: 'tight', shape: 'box', uppercase: true },

  // Culture & Icons
  { id: 'the-north-face', name: 'The North Face', category: 'Culture & Icons', difficulty: 'medium', color: '#111111', bg: '#F2EFE6', fontFamily: 'sans', letterSpacing: 'tight', shape: 'plain', uppercase: false },
  { id: 'nasa', name: 'NASA', category: 'Culture & Icons', difficulty: 'medium', color: '#F2EFE6', bg: '#0B3B8C', fontFamily: 'sans', letterSpacing: 'wider', shape: 'roundel', uppercase: true },
